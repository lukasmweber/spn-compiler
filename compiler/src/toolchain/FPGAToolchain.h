...
#ifndef SPNC_COMPILER_SRC_DRIVER_TOOLCHAIN_FPGATOOLCHAIN_H
#define SPNC_COMPILER_SRC_DRIVER_TOOLCHAIN_FPGATOOLCHAIN_H
...
namespace spnc {
    ...
    ///
    /// Toolchain generating FPGA Bitstreams using xspn-fpga.
    class FPGAToolchain : MLIRToolchain {
...
#endif //SPNC_COMPILER_SRC_DRIVER_TOOLCHAIN_FPGATOOLCHAIN_H
